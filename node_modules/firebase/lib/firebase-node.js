/*! @license Firebase v1.1.2 - License: https://www.firebase.com/terms/terms-of-service.html */ var k,aa=this;function m(a){return void 0!==a}function ba(){}function ca(a){a.gb=function(){return a.Id?a.Id:a.Id=new a}}
...
F.prototype.Ra=function(a,b){x("Query.on",2,4,arguments.length);Ka("Query.on",a,!1);z("Query.on",2,b,!1);var c=Qa("Query.on",arguments[2],arguments[3]);this.i.bc(this,a,b,c.cancel,c.$);return b};F.prototype.on=F.prototype.Ra;F.prototype.kb=function(a,b,c){x("Query.off",0,3,arguments.length);Ka("Query.off",a,!0);z("Query.off",2,b,!0);ya("Query.off",3,c);this.i.Bc(this,a,b,c)};F.prototype.off=F.prototype.kb;
F.prototype.Je=function(a,b){function c(g){f&&(f=!1,e.kb(a,c),b.call(d.$,g))}x("Query.once",2,4,arguments.length);Ka("Query.once",a,!1);z("Query.once",2,b,!1);var d=Qa("Query.once",arguments[2],arguments[3]),e=this,f=!0;this.Ra(a,c,function(b){e.kb(a,c);d.cancel&&d.cancel.call(d.$,b)})};F.prototype.once=F.prototype.Je;
...
d.K(b,c)}});return d.Ia(c)}var f=[],g={},h=!1,l=a;oc(l,function(a,b){if("string"!==typeof b||"."!==b.substring(0,1)){var c=R(l[b]);c.f()||(h=h||null!==c.m(),f.push({name:b,ka:c.m()}),g[b]=c)}});var n=Cc(f,g,!1);if(h){var p=Cc(f,g,!0);return new Ac(n,p,c)}return new Q(n,c)}var Dc=Math.log(2);function Ec(a){this.count=parseInt(Math.log(a+1)/Dc,10);this.Cd=this.count-1;this.oe=a+1&parseInt(Array(this.count+1).join("1"),2)}function Fc(a){var b=!(a.oe&1<<a.Cd);a.Cd--;return b}
...
function Pc(a,b){for(var c,d,e=1;e<arguments.length;e++){d=arguments[e];for(c in d)a[c]=d[c];for(var f=0;f<Nc.length;f++)c=Nc[f],Object.prototype.hasOwnProperty.call(d,c)&&(a[c]=d[c])}};function Qc(){this.yb={}}function Rc(a,b,c){m(c)||(c=1);A(a.yb,b)||(a.yb[b]=0);a.yb[b]+=c}Qc.prototype.get=function(){return Mc(this.yb)};function Sc(a){this.pe=a;this.jc=null}Sc.prototype.get=function(){var a=this.pe.get(),b=Mc(a);if(this.jc)for(var c in this.jc)b[c]-=this.jc[c];this.jc=a;return b};function Tc(a,b){this.vd={};this.Ec=new Sc(a);this.n=b;var c=1E4+2E4*Math.random();setTimeout(r(this.Sd,this),Math.floor(c))}Tc.prototype.Sd=function(){var a=this.Ec.get(),b={},c=!1,d;for(d in a)0<a[d]&&A(this.vd,d)&&(b[d]=a[d],c=!0);c&&(a=this.n,a.T&&(b={c:b},a.e("reportStats",b),a.Ga("s",b)));setTimeout(r(this.Sd,this),Math.floor(6E5*Math.random()))};var Uc={},Vc={};function Wc(a){a=a.toString();Uc[a]||(Uc[a]=new Qc);return Uc[a]}function Xc(a,b){var c=a.toString();Vc[c]||(Vc[c]=b());return Vc[c]};var Yc=null,Yc=require("faye-websocket").Client;function Zc(a,b,c){this.Sc=a;this.e=ec(this.Sc);this.frames=this.Eb=null;this.Ka=this.La=this.xd=0;this.fa=Wc(b);this.Za=(b.Va?"wss://":"ws://")+b.ha+"/.ws?v=5";b.host!==b.ha&&(this.Za=this.Za+"&ns="+b.Qa);c&&(this.Za=this.Za+"&s="+c)}var $c;
Zc.prototype.open=function(a,b){this.ja=b;this.Ee=a;this.e("Websocket connecting to "+this.Za);this.Ab=!1;wb.set("previous_websocket_failure",!0);try{this.Y=new Yc(this.Za)}catch(c){this.e("Error instantiating WebSocket.");var d=c.message||c.data;d&&this.e(d);this.Fa();return}var e=this;this.Y.onopen=function(){e.e("Websocket connected.");e.Ab=!0};this.Y.onclose=function(){e.e("Websocket connection was disconnected.");e.Y=null;e.Fa()};this.Y.onmessage=function(a){if(null!==e.Y)if(a=a.data,e.Ka+=a.length,
Rc(e.fa,"bytes_received",a.length),ad(e),null!==e.frames)bd(e,a);else{a:{v(null===e.frames,"We already have a frame buffer");if(6>=a.length){var b=Number(a);if(!isNaN(b)){e.xd=b;e.frames=[];a=null;break a}}e.xd=1;e.frames=[]}null!==a&&bd(e,a)}};this.Y.onerror=function(a){e.e("WebSocket error.  Closing connection.");(a=a.message||a.data)&&e.e(a);e.Fa()}};Zc.prototype.start=function(){};
Zc.isAvailable=function(){var a=!1;if("undefined"!==typeof navigator&&navigator.userAgent){var b=navigator.userAgent.match(/Android ([0-9]{0,}\.[0-9]{0,})/);b&&1<b.length&&4.4>parseFloat(b[1])&&(a=!0)}return!a&&null!==Yc&&!$c};Zc.responsesRequiredToBeHealthy=2;Zc.healthyTimeout=3E4;k=Zc.prototype;k.kc=function(){wb.remove("previous_websocket_failure")};function bd(a,b){a.frames.push(b);if(a.frames.length==a.xd){var c=a.frames.join("");a.frames=null;c=ua(c);a.Ee(c)}}
k.send=function(a){ad(this);a=u(a);this.La+=a.length;Rc(this.fa,"bytes_sent",a.length);a=nc(a,16384);1<a.length&&this.Y.send(String(a.length));for(var b=0;b<a.length;b++)this.Y.send(a[b])};k.Yb=function(){this.Oa=!0;this.Eb&&(clearInterval(this.Eb),this.Eb=null);this.Y&&(this.Y.close(),this.Y=null)};k.Fa=function(){this.Oa||(this.e("WebSocket is closing itself"),this.Yb(),this.ja&&(this.ja(this.Ab),this.ja=null))};k.close=function(){this.Oa||(this.e("WebSocket is being closed"),this.Yb())};
function ad(a){clearInterval(a.Eb);a.Eb=setInterval(function(){a.Y&&a.Y.send("0");ad(a)},Math.floor(45E3))};function cd(a){this.lb=a;this.vc=[];this.ab=0;this.Rc=-1;this.Sa=null}function dd(a,b,c){a.Rc=b;a.Sa=c;a.Rc<a.ab&&(a.Sa(),a.Sa=null)}function ed(a,b,c){for(a.vc[b]=c;a.vc[a.ab];){var d=a.vc[a.ab];delete a.vc[a.ab];for(var e=0;e<d.length;++e)if(d[e]){var f=a;uc(function(){f.lb(d[e])})}if(a.ab===a.Rc){a.Sa&&(clearTimeout(a.Sa),a.Sa(),a.Sa=null);break}a.ab++}};function fd(){this.set={}}k=fd.prototype;k.add=function(a,b){this.set[a]=null!==b?b:!0};k.contains=function(a){return A(this.set,a)};k.get=function(a){return this.contains(a)?this.set[a]:void 0};k.remove=function(a){delete this.set[a]};k.clear=function(){this.set={}};k.f=function(){return Lc(this.set)};k.count=function(){var a=this.set,b=0,c;for(c in a)b++;return b};function gd(a,b){pc(a.set,function(a,d){b(d,a)})}k.keys=function(){var a=[];pc(this.set,function(b,c){a.push(c)});return a};function hd(a,b,c){this.Sc=a;this.e=ec(a);this.Ka=this.La=0;this.fa=Wc(b);this.Dc=c;this.Ab=!1;this.ac=function(a){b.host!==b.ha&&(a.ns=b.Qa);var c=[],f;for(f in a)a.hasOwnProperty(f)&&c.push(f+"="+a[f]);return(b.Va?"https://":"http://")+b.ha+"/.lp?"+c.join("&")}}var id,jd;
hd.prototype.open=function(a,b){this.Bd=0;this.U=b;this.Nd=new cd(a);this.Oa=!1;var c=this;this.Ma=setTimeout(function(){c.e("Timed out trying to connect.");c.Fa();c.Ma=null},Math.floor(3E4));ic(function(){if(!c.Oa){c.ma=new kd(function(a,b,d,h,l){ld(c,arguments);if(c.ma)if(c.Ma&&(clearTimeout(c.Ma),c.Ma=null),c.Ab=!0,"start"==a)c.id=b,c.Ke=d;else if("close"===a)b?(c.ma.Xd=!1,dd(c.Nd,b,function(){c.Fa()})):c.Fa();else throw Error("Unrecognized command received: "+a);},function(a,b){ld(c,arguments);
ed(c.Nd,a,b)},function(){c.Fa()},c.ac);var a={start:"t"};a.ser=Math.floor(1E8*Math.random());c.ma.Ye&&(a.cb=c.ma.Ye);a.v="5";c.Dc&&(a.s=c.Dc);a=c.ac(a);c.e("Connecting via long-poll to "+a);md(c.ma,a,function(){})}})};hd.prototype.start=function(){var a=this.ma,b=this.Ke;a.ed=this.id;a.Md=b;for(a.Mc=!0;nd(a););};
...
k.Fa=function(){this.Oa||(this.e("Longpoll is closing itself"),this.Yb(),this.U&&(this.U(this.Ab),this.U=null))};k.close=function(){this.Oa||(this.e("Longpoll is being closed."),this.Yb())};k.send=function(a){a=u(a);this.La+=a.length;Rc(this.fa,"bytes_sent",a.length);a=va(a);a=Wb(a,!0);a=nc(a,1840);for(var b=0;b<a.length;b++){var c=this.ma;c.Qb.push({Pe:this.Bd,We:a.length,Dd:a[b]});c.Mc&&nd(c);this.Bd++}};function ld(a,b){var c=u(b).length;a.Ka+=c;Rc(a.fa,"bytes_received",c)}
...
function yd(a){var b=wd(a.be);a.C=new b("c:"+a.id+":"+a.Ad++,a.D);a.nd=b.responsesRequiredToBeHealthy||0;var c=zd(a,a.C),d=Ad(a,a.C);a.$b=a.C;a.Xb=a.C;a.w=null;a.Pa=!1;setTimeout(function(){a.C&&a.C.open(c,d)},Math.floor(0));b=b.healthyTimeout||0;0<b&&(a.hc=setTimeout(function(){a.hc=null;a.Pa||(a.C&&102400<a.C.Ka?(a.e("Connection exceeded healthy timeout but has received "+a.C.Ka+" bytes.  Marking connection healthy."),a.Pa=!0,a.C.kc()):a.C&&10240<a.C.La?a.e("Connection exceeded healthy timeout but has sent "+
a.C.La+" bytes.  Leaving connection alive."):(a.e("Closing unhealthy connection after timeout."),a.close()))},Math.floor(b)))}function Ad(a,b){return function(c){b===a.C?(a.C=null,c||0!==a.na?1===a.na&&a.e("Realtime connection lost."):(a.e("Realtime connection failed."),"s-"===a.D.ha.substr(0,2)&&(wb.remove("host:"+a.D.host),a.D.ha=a.D.host)),a.close()):b===a.w?(a.e("Secondary connection lost."),c=a.w,a.w=null,a.$b!==c&&a.Xb!==c||a.close()):a.e("closing an old connection")}}
...
function ae(a,b,c,d,e,f){c={p:c,d:d};m(f)&&(c.h=f);a.V.push({action:b,Td:c,G:e});a.Mb++;b=a.V.length-1;a.T&&ce(a,b)}function ce(a,b){var c=a.V[b].action,d=a.V[b].Td,e=a.V[b].G;a.V[b].Le=a.T;a.Ga(c,d,function(d){a.e(c+" response",d);delete a.V[b];a.Mb--;0===a.Mb&&(a.V=[]);e&&e(d.s,d.d)})}
...
k.pd=function(a,b){var c=this;Ue(this);var d="/users/"+encodeURIComponent(a.email),e=ue(a);e.rb._method="DELETE";this.Wb(d,e,function(a,d){!a&&d&&d.uid&&c.Ja&&c.Ja.uid&&c.Ja.uid===d.uid&&Se(c);O(b,a)})};k.Pc=function(a,b){Ue(this);var c="/users/"+encodeURIComponent(a.email)+"/password",d=ue(a);d.rb._method="PUT";d.rb.password=a.newPassword;this.Wb(c,d,function(a){O(b,a)})};
...
function Hf(a,b,c,d){var e=c.k();if(null!==e)return of(e)?[{path:c.path(),ta:b}]:Gf(a,e,c,b,d);var f=[];c.B(function(c){var e=b.Q()?P:b.P(c.name());c=Hf(a,e,c,d);f=f.concat(c)});return f};function Jf(a){this.D=a;this.fa=Wc(a);this.n=new Od(this.D,r(this.sc,this),r(this.qc,this),r(this.kd,this),r(this.$c,this));this.ae=Xc(a,r(function(){return new Tc(this.fa,this.n)},this));this.Xa=new Xa;this.Ha=new ie;this.g=new je;this.L=new tf(this.n,this.g.pa);this.bd=new ie;this.cd=new tf(null,this.bd);Kf(this,"connected",!1);this.U=new fe;this.I=new Le(a,r(this.n.I,this.n),r(this.n.yd,this.n),r(this.fd,this));this.fc=0}k=Jf.prototype;
k.toString=function(){return(this.D.Va?"https://":"http://")+this.D.host};k.name=function(){return this.D.Qa};function Lf(a){a=T(a.bd,new H(".info/serverTimeOffset")).X()||0;return(new Date).getTime()+a}function Mf(a){a=a={timestamp:Lf(a)};a.timestamp=a.timestamp||(new Date).getTime();return a}
k.sc=function(a,b,c){this.fc++;this.Jd&&(b=this.Jd(a,b));var d,e,f=[];9<=a.length&&a.lastIndexOf(".priority")===a.length-9?(d=new H(a.substring(0,a.length-9)),e=T(this.g.va,d).Ia(b),f.push(d)):c?(d=new H(a),e=T(this.g.va,d),pc(b,function(a,b){var c=new H(b);".priority"===b?e=e.Ia(a):(e=e.Aa(c,R(a)),f.push(d.J(b)))})):(d=new H(a),e=R(b),f.push(d));a=If(this.L,d,e,this.g.O);b=!1;for(c=0;c<a.length;++c){var g=a[c];b=ke(this.g,g.path,g.ta)||b}b&&(d=Nf(this,d));Cf(this.L,d,f)};
...
b,f)}};k.sd=function(a,b,c){this.e("setPriority",{path:a.toString(),ka:b});var d=Mf(this),d=oe(b,d),d=T(this.g.O,a).Ia(d),d=If(this.L,a,d,this.g.O),e=this.g.set(a,d),f=this;this.n.put(a.toString()+"/.priority",b,function(b,d){"permission_denied"===b&&M("setPriority at "+a+" failed: "+b);ne(f.g,e);le(f.g,a);var l=Nf(f,a);Cf(f.L,l,[]);Pf(c,b,d)});b=Nf(this,a);Cf(f.L,b,[])};
...
function Pf(a,b,c){a&&uc(function(){if("ok"==b)a(null,c);else{var d=(b||"error").toUpperCase(),e=d;c&&(e+=": "+c);e=Error(e);e.code=d;a(e)}})};function Vf(a,b,c,d,e){function f(){}a.e("transaction on "+b);var g=new G(a,b);g.Ra("value",f);c={path:b,update:c,G:d,status:null,Rd:Xb(),Nc:e,Vd:0,Kc:function(){g.kb("value",f)},Lc:null};a.Ha.aa=Wf(a,a.Ha.aa,a.g.O.aa,a.Xa);d=c.update(T(a.Ha,b).X());if(m(d)){Fa("transaction failed: Data returned ",d);c.status=1;e=I(a.Xa,b);var h=e.k()||[];h.push(c);Ya(e,h);h="object"===typeof d&&null!==d&&A(d,".priority")?d[".priority"]:T(a.g.O,b).m();e=Mf(a);d=R(d,h);d=qe(d,e);U(a.Ha,b,d);c.Nc&&(U(a.g.pa,b,d),Cf(a.L,
...
(w=w.Ia(s.m()));e=e.Aa(l,w);c[h].Nc&&(f=f.Aa(l,w))}else n=!0,p="nodata"}n&&(c[h].status=3,setTimeout(c[h].Kc,Math.floor(0)),c[h].G&&(n=new G(a,c[h].path),l=new S(e.N(l),n),"nodata"===p?g.push(r(c[h].G,null,null,!1,l)):g.push(r(c[h].G,null,Error(p),!1,l))))}U(a.Ha,d,e);U(a.g.pa,d,f);Zf(a,a.Xa);for(h=0;h<g.length;h++)uc(g[h]);Xf(a)}return d}function cg(a,b){for(var c,d=a.Xa;null!==(c=D(b))&&null===d.k();)d=I(d,c),b=Ta(b);return d}
...
c=new xb(d.host,d.Va,c,"ws"===d.scheme||"wss"===d.scheme);d=new H(d.Ob);e=d.toString();var f;!(f=!q(c.host)||0===c.host.length||!Da(c.Qa))&&(f=0!==e.length)&&(e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),f=!(q(e)&&0!==e.length&&!Ca.test(e)));if(f)throw Error(y("new Firebase",1,!1)+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".');if(b)if(b instanceof X)e=b;else if(q(b))e=X.gb(),c.wc=b;else throw Error("Expected a valid Firebase.Context for second argument to new Firebase()");
...
G.prototype.qd=function(a,b){x("Firebase.resetPassword",2,2,arguments.length);E("Firebase.resetPassword",1,a,!1);Pa("Firebase.resetPassword",a,"email");z("Firebase.resetPassword",2,b,!1);this.i.I.qd(a,b)};G.prototype.resetPassword=G.prototype.qd;G.goOffline=function(){x("Firebase.goOffline",0,0,arguments.length);X.gb().Na()};G.goOnline=function(){x("Firebase.goOnline",0,0,arguments.length);X.gb().qb()};
